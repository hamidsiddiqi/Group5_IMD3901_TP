...
public class milesPickIngredent : MonoBehaviour
{
    ...
    public void grabIngredient(GameObject container)
    {
        ...
        else if (container.name == "KnifeScoop")
        {
            newFood = Instantiate(knifeScoop, hand.transform);
        }
        else
        {
